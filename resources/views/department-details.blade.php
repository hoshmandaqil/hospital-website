...
<head>
    ...
    <title>{{ $departmentName ?? 'Department Details' }} - Bayazid Rokhan Hospital</title>
...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gray-50">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    ...
                    <div class="flex items-center space-x-8">
                        ...
                        <a href="/#contact" class="bg-gradient-to-r from-teal-500 to-emerald-500 text-white px-6 py-2 rounded-lg font-semibold hover:from-teal-600 hover:to-emerald-600 transition-all duration-300">
                            Book Appointment
                        </a>
                    </div>
                </div>
        ...
        <!-- Main Content -->
        <main class="pt-16">
            @livewire('department-details', ['departmentId' => $departmentId])
        </main>
